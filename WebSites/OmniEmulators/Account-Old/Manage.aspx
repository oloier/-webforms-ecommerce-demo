...
<%@ Register Src="~/Account-Old/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>
        ...
        <div class="col-md-12">
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <p>You're logged in as <strong><%: HttpContext.Current.User.Identity.Name %></strong>.</p>
                    <div class="form-horizontal">
